import 'package:evently_app/feature/Event/presentation/event_details_screan.dart';
import 'package:evently_app/feature/provider/events_provider.dart';
import 'package:evently_app/feature/tabs/home_tab/widget/tabbar_header.dart';
import 'package:evently_app/feature/tabs/home_tab/widget/event_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return isLoadig
        ...
        : Column(
            children: [
              TabbarHeader(),
              eventsProvider.eventsDisplay.isEmpty
                  ? Padding(
